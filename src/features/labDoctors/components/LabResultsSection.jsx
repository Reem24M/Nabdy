...
<div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-5">
  {/* Normal */}
  <div className="p-3 bg-[#169CF6]/10 border border-[#169CF6]/20 !rounded-lg">
    <div className="flex items-center justify-between">
      <div>
        <p className="text-white/60 text-xs">Normal</p>
        <p className="text-lg font-bold text-white">{getStatusCount("normal")}</p>
      </div>
      <div className="w-6 h-6 bg-[#169CF6]/20 flex items-center justify-center !rounded-full">
        <div className="w-2 h-2 bg-[#169CF6] !rounded-full" />
      </div>
    </div>
  </div>
  ...
  <div className="p-3 bg-[#169CF6]/10 border border-[#169CF6]/20 !rounded-lg">
    <div className="flex items-center justify-between">
      <div>
        ...
        <p className="text-lg font-bold text-white">{getStatusCount("warning")}</p>
      </div>
      <div className="w-6 h-6 bg-[#169CF6]/20 flex items-center justify-center !rounded-full">
        <div className="w-2 h-2 bg-[#169CF6] !rounded-full" />
      </div>
  ...
  <div className="p-3 bg-[#169CF6]/10 border border-[#169CF6]/20 !rounded-lg">
    <div className="flex items-center justify-between">
      <div>
        ...
        <p className="text-lg font-bold text-white">{getStatusCount("danger")}</p>
      </div>
      <div className="w-6 h-6 bg-[#169CF6]/20 flex items-center justify-center !rounded-full">
        <div className="w-2 h-2 bg-[#169CF6] !rounded-full" />
      </div>
  ...
  <div className="p-3 bg-[#169CF6]/10 border border-[#169CF6]/20 !rounded-lg">
    <div className="flex items-center justify-between">
      <div>
        ...
        <p className="text-lg font-bold text-white">{labResults.length}</p>
      </div>
      <div className="w-6 h-6 bg-[#169CF6]/20 flex items-center justify-center !rounded-full">
        <div className="w-2 h-2 bg-[#169CF6] !rounded-full" />
      </div>
