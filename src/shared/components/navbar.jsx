...
import { Menu, X, Siren, LogOut, User, Settings, LayoutDashboardIcon} from 'lucide-react';
            ...
            {role === 'guest' ? (
              ...
              <div className="flex items-center gap-3">
                ...
                {role!=='guest'&&<button
                  ...
                  className="flex items-center gap-2 px-3 py-2.5 hover:bg-white/10 !rounded-lg transition-all duration-300 group"
                >
